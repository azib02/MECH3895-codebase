...
# Parent = ketchup_1_main, Child = robot0_right_hand
T_HAND_ON_KETCHUP = np.array(
    [
        [4.39121571e-04, -9.99955284e-01, 9.44649518e-03, -0.02065064],
        [-2.60673997e-02, -9.45473230e-03, -9.99615475e-01, 0.14929166],
        [9.99660091e-01, 1.92707153e-04, -2.60703858e-02, -0.00604984],
        [0.0, 0.0, 0.0, 1.0],
    ]
)

# Parent = basket_1_main, Child = ketchup_1_main
T_KETCHUP_IN_BASKET = np.array(
    [
        [0.99960899, -0.02793209, -0.00128699, -0.00975482],
        [-0.00166469, -0.01350292, -0.99990745, -0.00330437],
        [0.02791212, 0.99951862, -0.01354414, 0.06672376],
        [0.0, 0.0, 0.0, 1.0],
    ]
)
...
def run_solver(env, bddl_file=None):
    ...
    """
    print("Phase 1: Picking up ketchup...")

    pick_pose = get_matrix(env, "ketchup_1_main") @ T_HAND_ON_KETCHUP
    ...
    print("Phase 2: Placing ketchup in basket...")

    goal_pose = get_matrix(env, "basket_1_main") @ T_KETCHUP_IN_BASKET @ T_HAND_ON_KETCHUP

    move_to_smooth(env, goal_pose, offset=[0, 0, 0.17], steps=100, grip=1.0)
