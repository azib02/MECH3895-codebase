...
def run_solver(env, bddl_file=None):
    ...
    move_to_smooth(env, bowl_start, offset=[0, 0, 0.15], steps=80)
    move_to_smooth(env, bowl_start, offset=[0, 0, -0.05], steps=60)

    gripper_action(env, cmd=1.0, steps=20)
    ...
    move_to_smooth(env, goal_pose, offset=[0, 0, 0.15], steps=80, grip=1.0)
    move_to_smooth(env, goal_pose, offset=[0, 0, 0.07], steps=60, grip=1.0)
