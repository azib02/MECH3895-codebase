...
# Parent = wooden_cabinet_1_main, Child = target placement zone
T_PLACEMENT_ZONE = np.array(
    [
...
def run_solver(env, bddl_file=None):
    ...
    move_to_smooth(env, bowl_start, offset=[0, 0, 0.35], steps=100, grip=1.0)

    print("Phase 2: Placing bowl on cabinet...")

    goal_pose = get_matrix(env, "wooden_cabinet_1_main") @ T_PLACEMENT_ZONE @ T_HAND_ON_BOWL
