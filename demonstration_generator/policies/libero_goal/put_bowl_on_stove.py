...
# Parent = flat_stove_1_burner_plate, Child = akita_black_bowl_1_main
T_BOWL_ON_STOVE = np.array(
    [
        [-9.96476920e-01, 5.99797513e-02, 5.86189138e-02, -0.00062075],
        [-5.84217278e-02, -9.97900864e-01, 2.79422147e-02, 0.00269367],
...
def run_solver(env, bddl_file=None):
    ...
    pick_pose = get_matrix(env, "akita_black_bowl_1_main") @ T_HAND_ON_BOWL
    ...
    print("Phase 2: Placing bowl on stove...")

    goal_pose = get_matrix(env, "flat_stove_1_burner_plate") @ T_BOWL_ON_STOVE @ T_HAND_ON_BOWL
